            ...
            steps{
                withCredentials([string(credentialsId: 'GH-Token', variable: 'TOKEN')]) {
                   sh '''#!/bin/bash
                       ...
                       -d '{"tag_name":"v99.0.0","target_commitish":"$BRANCH_NAME","name":"v99.0.0","body":"Description of the release","draft":false,"prerelease":false,"generate_release_notes":false}'
                      '''
                }        
            }
        }
